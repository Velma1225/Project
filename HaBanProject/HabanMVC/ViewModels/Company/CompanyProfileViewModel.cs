namespace HabanMVC.ViewModels.Company
{
    public class CompanyProfileViewModel
    {
        ...
        public List<WorkViewModel> Work { get; set; }
        public List<EnvironmentPicViewModel> EnvironmentPic { get; set; }
        public List<SimilarCompanyViewModel> SimilarCompany { get; set; }


        //Dropdown
        public List<DistrictListViewModel> DistrictList { get; set; }
        public List<JobCategoryViewModel> JobCategory { get; set; }
    }
    ...
    public class SimilarCompanyViewModel
    {
        public string CompanyName { get; set; }
